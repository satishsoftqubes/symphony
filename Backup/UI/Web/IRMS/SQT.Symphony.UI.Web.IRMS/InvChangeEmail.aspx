<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvChangeEmail.aspx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.InvChangeEmail" %>
        ...
        <div class="login_main">
            <table border="0" cellspacing="0" cellpadding="0" class="box">
                <tr>
                    ...
                    <td class="loginboxtopcenter" align="left">
                        CHANGE EMAIL
                    </td>
                ...
                <tr>
                    ...
                    <td class="loginbox_bg">
                        <div class="loginbox_content">
                            <div id="dvSuccess" runat="server" style="width: 250px; height: 130px;">
                                <br />
                                <br />
                                You have changed your Mail Id .A new Id and Password will be generated for your  login  and will be sent on new  Mail Id
                                <br />
                                <br />
                                Please, &nbsp;<a href="Default.aspx"><b>Click here</b></a>&nbsp; to login.
                            </div>
                        </div>
                    </td>
