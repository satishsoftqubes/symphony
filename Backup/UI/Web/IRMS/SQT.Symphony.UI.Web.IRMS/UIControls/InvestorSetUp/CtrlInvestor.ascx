<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlInvestor.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.InvestorSetUp.CtrlInvestor" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:inline-block;">
                                    <asp:Label ID="lblMsgDateValidate" runat="server" ForeColor="Red"></asp:Label>
                                </div>
                                                ...
                                                <table width="100%" cellpadding="3" cellspacing="3">
                                                    <tr>
                                                        <td style="width: 150px;">
                                                            <asp:Label ID="litSurName" runat="server" Text="Person Name" CssClass="RequireFile"></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblCoOrdinatorInvestor" runat="server" Text="Investor Grouping"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlCoOrdinatorInvestor" runat="server" Style="width: 202px;">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRefrence" runat="server" SkinID="CmpTextbox" MaxLength="225"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div id="dvInvDateOfBirth" runat="server" class="rfv_ErrorStar" visible="false" style="float: right;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPANNo" runat="server" MaxLength="45" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPOAHolder" runat="server" MaxLength="120" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtBankName" runat="server" MaxLength="125" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtBankAccNo" runat="server" MaxLength="45" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtBankAcctHolderName" runat="server" MaxLength="250" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtCompanyName" runat="server" MaxLength="125" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDesignation" runat="server" MaxLength="125" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" class="pagesubheader">
                                                            <asp:Literal ID="Literal6" runat="server" Text="Sale Information"></asp:Literal>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="litManagerType" runat="server" Text="Sale Through" CssClass="RequireFile"></asp:Label>
                                                            <span class="erroraleart">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="litRelationManagerID" runat="server" Text="Name of Person" CssClass="RequireFile"></asp:Label>
                                                            <span class="erroraleart">
                                                ...
                                                <table width="100%" cellpadding="3" cellspacing="3">
                                                    <tr>
                                                        <td style="width: 130px;">
                                                            <asp:Label ID="Literal10" runat="server" Text="Person Name"></asp:Label>
                                                        </td>
                                                        <td style="vertical-align: top;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:Literal ID="litRefDateOfBirth" runat="server" Text="Date of Birth"></asp:Literal>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRefPOAHolder" runat="server" MaxLength="100" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Literal ID="litRefAcctHolderName" runat="server" Text="Acct. Holder Name"></asp:Literal>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtRefBankAcctHolderName" runat="server" MaxLength="250" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRefDesignation" runat="server" MaxLength="125" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                        ...
                                        <div id="tabs-3">
                                            <div style="height: 1650px;">
                                                <table width="100%" cellpadding="3" cellspacing="3">
                                                    <tr>
                                                        <td style="width: 130px;">
                                                            <asp:Label ID="lbl2JOName" runat="server" Text="Person Name"></asp:Label>
                                                        </td>
                                                        <td style="vertical-align: top;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:Literal ID="ltr2JODateOfBirth" runat="server" Text="Date of Birth"></asp:Literal>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt2JOPOAHolder" runat="server" MaxLength="100" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt2JOBanckAcctHolderName" runat="server" MaxLength="250" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txt2JODesignation" runat="server" MaxLength="125" SkinID="CmpTextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
