<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlPropertyInsurance.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.InvestorSetUp.CtrlPropertyInsurance" %>
...
<script language="javascript" type="text/javascript">
    ...
    function fnCheckPaidAmount() {
        ...
        if (parseFloat(PaidAmount) > 0) {
            ...
            document.getElementById('<%=lblPaidAmountErrorMessage.ClientID %>').innerHTML = 'Invalid Premium Amount.';
        }
    }
</script>
<style type="text/css">
                                ...
                                <table width="100%" cellpadding="3" cellspacing="3">
                                    ...
                                    <tr>
                                        <td align="left" valign="top" style="width: 25%;">
                                            <asp:Label ID="litPaymentScheduleID" runat="server" Text="Insurance Year From" CssClass="RequireFile"></asp:Label>
                                            <span class="erroraleart">
                                    ...
                                    <tr>
                                        <td align="left" valign="top" style="width: 25%;">
                                            <asp:Label ID="lblTo" runat="server" Text="Insurance Year To" CssClass="RequireFile"></asp:Label>
                                            <span class="erroraleart">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="litPaidAmount" runat="server" Text="Premium Amount" CssClass="RequireFile"></asp:Label>
                                            <span class="erroraleart">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtPaidAmount" runat="server" MaxLength="10" SkinID="CmpTextbox"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Literal ID="litPaymentRefNo" runat="server" Text="Ref. Receipt No"></asp:Literal>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtPaymentRefNo" SkinID="CmpTextbox" runat="server" MaxLength="10"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtChqTranNo" SkinID="CmpTextbox" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Literal ID="litVendorName" runat="server" Text="Vendor Name"></asp:Literal>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtVendorName" SkinID="CmpTextbox" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtNotes" runat="server" TextMode="MultiLine" SkinID="Medium" Height="60px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                ...
                                <div class="box_leftmargin_content">
                                        ...
                                        <table id="tbl" cellpadding="2" cellspacing="0" width="100%" border="0" class="pageinfo">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajx:CalendarExtender ID="calDateFrom" runat="server" PopupButtonID="imbDateFrom"
                                                        CssClass="MyCalendar" TargetControlID="txtDateFrom">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajx:CalendarExtender ID="calExtDateTo" runat="server" PopupButtonID="imbDateTo"
                                                        CssClass="MyCalendar" TargetControlID="txtDateTo">
                                                    </ajx:CalendarExtender>
                                    ...
                                    <div>
                                        <div style="height: 505px; overflow: auto;">
                                            <asp:GridView ID="grdInsurnaceList" runat="server" ShowHeader="false" ShowFooter="false"
                                                SkinID="gvNoPaging" AutoGenerateColumns="false" Width="92%" OnRowCommand="grdInsurnaceList_RowCommand"
                                                OnRowDataBound="grdInsurnaceList_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <div class="rightmargin_grid">
                                                                ...
                                                                <div class="leftmargin_icons">
                                                                    ...
                                                                    <asp:ImageButton ID="btnDelete" CommandName="DELETECMD" ToolTip="Delete" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "InvestorPaymentReceiptID")%>'
