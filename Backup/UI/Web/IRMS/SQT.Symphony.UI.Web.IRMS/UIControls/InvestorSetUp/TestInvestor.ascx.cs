...
{
    public partial class TestInvestor : System.Web.UI.UserControl
    {
        #region Variable
        ...
        private void ClearControlValue()
        {
            ...
            txtRefCCity.Text = txtRefCState.Text = txtRefCCountry.Text = txtRefCPostCode.Text = txtRefAge.Text = txtRefPANNo.Text = txtRefPOAHolder.Text = txtRefBankNo.Text = txtRefBankAccNo.Text = txtRefCompanyName.Text = txtRefDesignation.Text = "";
            
            txt2JOAddress.Text = txt2JOAge.Text = txt2JOBankAccountNo.Text = txt2JOBankName.Text = txt2JOCity.Text = txt2JOCompanyName.Text = txt2JOCountry.Text = txt2JODesignation.Text = txt2JOEmail.Text = txt2JOFirstName.Text = txt2JOIFSCCode.Text = txt2JOLandlineNo.Text = txt2JOLastName.Text = txt2JOMobilecode.Text = txt2JOMobileNo.Text = txt2JOPanNo.Text = txt2JOPOAHolder.Text = txt2JOPostalAddress.Text = txt2JOPostalCity.Text = txt2JOPostalCountry.Text = txt2JOPostalState.Text = txt2JOPostalZipCode.Text = txt2JOState.Text = txt2JOZipCode.Text = "";
        ...
        private void BindDDL()
        {
            ...
            //}            
            //else
            //    ddlRelationManagementID.SelectedValue = Guid.Empty.ToString();

            if (strManagerType.ToUpper() != "ADMIN")
            {
                // ddlSManagerType.SelectedValue = Convert.ToString(Session["InvUserType"]);
            ...
            if (strManagerType.ToUpper() != "ADMIN")
            {
                //ddlSManager.SelectedValue = Convert.ToString(Session["UserTypeID"]);
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (litMobileNo != null)
                    {
                        ...
                        {
                            if (strMobileNo.IndexOf("-") > 0)
                            {
                                string[] words = strMobileNo.Split('-');
                                if (words.Length > 1)
                                {
                                    if (Convert.ToString(words[0]) != "")
                                        litMobileNo.Text = Convert.ToString(strMobileNo);
                                    else
                                        litMobileNo.Text = Convert.ToString(strMobileNo.Replace("-", ""));
                                }
                                else
                                    litMobileNo.Text = Convert.ToString(strMobileNo.Replace("-", ""));
                            }
