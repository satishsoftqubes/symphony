<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlConversionExecutives.ascx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlConversionExecutives" %>
                    ...
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">
                        <tr>
                            <td align="left" valign="top" style="width: 120px;">
                                <asp:Literal ID="litName" runat="server" Text="Channel Partner Firm"></asp:Literal>
                            </td>
                            <td>
                                <asp:TextBox ID="txtChannelPartnerFirm" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Literal ID="litExeName" runat="server" Text="Executive Name"></asp:Literal>
                            </td>
                            <td>
