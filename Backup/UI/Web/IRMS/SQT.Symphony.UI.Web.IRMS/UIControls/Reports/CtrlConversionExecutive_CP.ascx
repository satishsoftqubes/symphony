<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlConversionExecutive_CP.ascx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlConversionExecutive_CP" %>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="box">
            <tr>
                ...
                <td class="boxtopcenter">
                    Conversion Report - Channel Partner
                </td>
