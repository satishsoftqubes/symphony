<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlPaymentDueReport.ascx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlPaymentDueReport" %>
                    ...
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">                        
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlInvestor" runat="server" ></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
