<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlInvestorTerm.ascx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlInvestorTerm" %>
