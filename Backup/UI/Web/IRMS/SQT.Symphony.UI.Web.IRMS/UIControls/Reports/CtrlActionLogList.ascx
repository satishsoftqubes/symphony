<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlActionLogList.ascx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlActionLogList" %>
            ...
            <tr>
                ...
                <td>
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">                        
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ajx:CalendarExtender ID="calStartDate" runat="server" TargetControlID="txtStartDate"
                                    PopupButtonID="imgSColor" CssClass="MyCalendar">
                        ...
                        <tr>
                            <td align="left" valign="top" style="width: 100px;">
                                <asp:Literal ID="ltActionType" runat="server" Text="Action Type"></asp:Literal>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlActionType" runat="server" ></asp:DropDownList>
                            </td>
                        </tr>
                         <tr>
                            <td align="left" valign="top" style="width: 100px;">
                                <asp:Literal ID="litActionObject" runat="server" Text="Action Object"></asp:Literal>
                            </td>
                            <td>
                                <asp:TextBox ID="txtActionObject" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
