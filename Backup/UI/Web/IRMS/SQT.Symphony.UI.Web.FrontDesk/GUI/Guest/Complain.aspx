<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/Site.Master"
    CodeBehind="Complain.aspx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.GUI.Guest.Complain" %>

<%@ Register Src="~/UIControls/Guest/CtrlComplain.ascx" TagName="Complain" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <uc1:Complain ID="ucCtrlComplain" runat="server" />
</asp:Content>
