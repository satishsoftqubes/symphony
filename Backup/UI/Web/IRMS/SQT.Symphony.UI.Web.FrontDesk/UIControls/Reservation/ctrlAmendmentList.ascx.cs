...
{
    public partial class ctrlAmendmentList : System.Web.UI.UserControl
    {
        ...
        protected void btnSaveCounterData_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BindAmendAuthorizationData(this.CurrentSelectedIndex);
        ...
        private void CheckUserAuthorization()
        {
            if (clsSession.UserType.ToUpper() != "SUPERADMIN")
                this.UserRights = clsCommon.GetUserAuthorization(clsSession.UserID, "AmendmentList.aspx");
            else
        ...
        private void BindBreadCrumb()
        {
            ...
            dr3["NameColumn"] = "Amend Reservation List";
            dr3["Link"] = "";
            dt.Rows.Add(dr3);
        ...
        private void BindReservationGrid()
        {
            try
            {
                ...
                //GetAmendReservationListData(Guid? ReservationID, Guid? PropertyID, Guid? CompanyID, string Mode, string GuestFullName, string MobileNo, string ReservationNo, DateTime? CheckInDate)

                DataSet dsReservationList = ReservationBLL.GetAmendReservationListData(null, clsSession.PropertyID, clsSession.CompanyID, null, strName, strMobileNo, strReservationNo, null);
        ...
        private void BindAmendAuthorizationData(int index)
        {
            try
            {
