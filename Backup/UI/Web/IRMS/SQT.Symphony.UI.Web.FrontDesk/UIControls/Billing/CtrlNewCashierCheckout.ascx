<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlNewCashierCheckout.ascx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Billing.CtrlNewCashierCheckout" %>
