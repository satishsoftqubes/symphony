<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MsgBox.ascx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.CommonControls.MsgBox" %>
            ...
            <asp:Panel ID="MessageBox" runat="server">
                <div style="width: 500px; height: 200px; margin-top: 25px;">
                    <div class="box_col1">
                        <div class="box_head">
                            <span>
                                <asp:Literal ID="litHeaderCustomeMessage" runat="server" Text="Message"></asp:Literal></span>
                        </div>
                        <div class="clear">
                        </div>
                        <div class="box_form">
