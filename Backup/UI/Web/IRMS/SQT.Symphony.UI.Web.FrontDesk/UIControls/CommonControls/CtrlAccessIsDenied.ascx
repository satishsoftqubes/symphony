<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlAccessIsDenied.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.CommonControls.CtrlAccessIsDenied" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="box" style="border: none;">
                        <tr>
                            ...
                            <td class="boxtopcenter">
                                <asp:Literal ID="litMainHeader" runat="server" Text="ACCESS DEINED"></asp:Literal>
                            </td>
                                                        ...
                                                        <td width="800">
                                                            ...
                                                            <p align="left">
                                                                <font face="Arial" style="font-weight: bold; color: #0067A4;" size="5">
                                                                    <asp:Literal ID="litHeaderAccessDenied" runat="server" Text="Access Denied"></asp:Literal></font>
                                                                <br />
                                                                <br />
                                                                <p align="left">
                                                                    <font face="Arial" style="color: #909092;" size="4">
                                                                        <asp:Literal ID="litMsgAccessDeniedM" Text="You don't have the required permission to access this page."
