<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="YeildCalculation.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Report.YeildCalculation" %>
...
<asp:Panel ID="pnlOccupancy" runat="server" Width="900px" Style="display: none;">
    <div class="box_col1">
        <div class="box_head">
            <span>
                <asp:Literal ID="Literal1" Text="Yield Calculation" runat="server"></asp:Literal></span></div>
        <div class="clear">
        </div>
        <div class="box_form">
                    ...
                    <td style="padding-bottom: 15px; border: 0px;">
                        <div style="padding-bottom: 5px; text-align: center;">
                            ...
                            <div style="font-family: Arial; font-weight: bold; font-size: 14pt;">
                                <asp:Literal ID="Literal2" Text="Yield Calculation" runat="server"></asp:Literal>
                            </div>
                        </div>
                        <table cellpadding="2" cellspacing="2" width="100%">
                            <tr>
                                <td style="border: 0px;">
                                    ...
                                    <asp:GridView ID="grdYeild" runat="server" SkinID="gvAutoColumns" Width="100%" HeaderStyle-BorderStyle="Solid"
                                        HeaderStyle-BorderColor="Black" HeaderStyle-BorderWidth="1pt" CssClass="grid_content"
                                        Font-Bold="true" BorderStyle="Solid" BorderColor="Black" BorderWidth="1pt" GridLines="Vertical">
                                        <EmptyDataTemplate>
