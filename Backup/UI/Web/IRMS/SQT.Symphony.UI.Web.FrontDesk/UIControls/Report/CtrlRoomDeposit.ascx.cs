...
{
    public partial class CtrlRoomDeposit : System.Web.UI.UserControl
    {
        #region Variable
        ...
        protected void LoadReport()
        {
            try
            {
                Session.Add("ReportName", "Room Deposit");
                ...
                ds = BookKeepingBLL.GetRPTRoomDeposit(clsSession.CompanyID, clsSession.PropertyID, iCntID, iUserID, startdt, enddt);
