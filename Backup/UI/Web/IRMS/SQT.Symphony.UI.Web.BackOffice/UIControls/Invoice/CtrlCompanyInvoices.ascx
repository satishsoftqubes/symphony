<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlCompanyInvoices.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.BackOffice.UIControls.Invoice.CtrlCompanyInvoices" %>
                            ...
                            <td align="left">
                                <div class="box_form">
                                    <table cellpadding="2" cellspacing="2" width="100%">
                                        <tr>
                                            <td colspan="2">
                                                <fieldset style="border: 1px solid #ccc !important; padding-left:15px;">
