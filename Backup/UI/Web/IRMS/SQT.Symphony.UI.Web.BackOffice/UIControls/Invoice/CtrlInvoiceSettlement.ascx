<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlInvoiceSettlement.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.BackOffice.UIControls.Invoice.CtrlInvoiceSettlement" %>
                                ...
                                <div class="box_form">
                                    ...
                                    <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                        <tr>
                                            ...
                                            <td width="280px">
                                                <asp:DropDownList ID="ddlSrchCompany" runat="server"></asp:DropDownList>
                                            </td>
                                            <td width="180px">
                                                <asp:RadioButtonList ID="rdblViewType" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" Width="170px">
