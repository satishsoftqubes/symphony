<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTaxSetup.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.BackOffice.UIControls.AccountSetup.CtrlTaxSetup" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <table width="100%" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TextBox1" runat="server" MaxLength="15" SkinID="nowidth" Style="text-align: right;"
                                                Width="80px"></asp:TextBox>
