<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlUserSetting.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.Configuration.UIControls.UserSetup.CtrlUserSetting" %>
                            ...
                            <td align="left">
                                <div class="box_form">
                                    <table cellpadding="2" cellspacing="2" width="100%">
                                        ...
                                        <tr id="trManageResourceFileHeader">
                                            <td>
                                                <h1>
                                                    <asp:Label ID="lblHeaderManageResourceFile" runat="server" Text="Manage Resource Files"></asp:Label>
                                                </h1>
                                                <hr>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <%--<asp:LinkButton ID="lnkResourceFileManagement" runat="server" Text="Resource file Management" PostBackUrl="~/GUI/Configurations/ManageResourceFile.aspx"></asp:LinkButton>--%>
                                                <asp:HyperLink ID="lnkResourceFileManagement" NavigateUrl="~/GUI/Configurations/ResourceManagement.aspx" runat="server" Text="Resource file Management" Target="_blank"></asp:HyperLink>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
