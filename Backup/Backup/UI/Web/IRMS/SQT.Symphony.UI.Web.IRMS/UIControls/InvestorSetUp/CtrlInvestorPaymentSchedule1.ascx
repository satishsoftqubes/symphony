<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlInvestorPaymentSchedule1.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.InvestorSetUp.CtrlInvestorPaymentSchedule1" %>
...
<script language="javascript" type="text/javascript">
    ...
    function fnCountTotal(blurFrom) {
        if (Page_ClientValidate("InvestorPayment")) {
            ...
            var totalPurchaseValue = parseFloat(document.getElementById('ContentPlaceHolder1_CtrlInvestorPaymentSchedule1_lblTotalPurchaseValue').value);
            ...
            if (totalGridCount > totalPurchaseValue) {
                ...
                document.getElementById('<%= lblAlertMessage.ClientID  %>').innerHTML = 'Overdue payable amount.';
                $find('mpeAlertMessage').show();
                return false;
            }
            else {
                                    ...
                                    <tr>
                                        <td style="padding: 10px 0px;" class="dTableBox">
                                            <asp:GridView ID="gvPaymentSchedules" runat="server" SkinID="gvNoPaging" AutoGenerateColumns="False"
                                                DataKeyNames="IsReceiptGenerated,PaymentScheduleID" ShowFooter="true" Width="100%"
                                                OnRowCommand="gvPaymentSchedules_RowCommand" OnRowDataBound="gvPaymentSchedules_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="% Due" ItemStyle-Width="30px" HeaderStyle-HorizontalAlign="Left"
                                                        ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtDue" runat="server" SkinID="nowidth" Width="50px" MaxLength="5"
                                                                onblur="fnCountTotal('PERCENTAGE');" Text='<%# DataBinder.Eval(Container.DataItem, "Due") %>'></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField HeaderText="Amount Payable" ItemStyle-Width="90px" HeaderStyle-HorizontalAlign="Left"
                                                        ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtAmountPayable" runat="server" SkinID="Search" Width="70px" MaxLength="18"
                                                                onblur="fnCountTotal('AMOUNT');" Text='<%# DataBinder.Eval(Container.DataItem, "AmountPayable") %>'></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField HeaderText="Due Date" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Left"
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            &nbsp;<img src="../../images/clear.png" id="imgClearDueDate" style="vertical-align: middle;"
                                                                onclick="fnClearDate('<%# Container.DataItemIndex %>');" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Sch. Type" ItemStyle-Width="50px" HeaderStyle-HorizontalAlign="Left"
                                                        ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                        ...
                                        <td align="left" valign="top" style="text-align: right;">
                                            ...
                                            <div style="float: right; width: auto; display: inline-block; height: 30px;">
                                                ...
                                                <asp:Button ID="btnAddNewRow" Text="Add New Row" Style="display: inline-block; margin-left: 5px;"
                                                    ...
                                                    OnClientClick="return fnCountTotal('SAVE');" ValidationGroup="InvestorPayment"
