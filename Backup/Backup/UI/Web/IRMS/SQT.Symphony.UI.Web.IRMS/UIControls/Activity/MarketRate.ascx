<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MarketRate.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Activity.MarketRate" %>
                                ...
                                <table width="100%" cellpadding="3" cellspacing="3">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <ajx:CalendarExtender ID="ajxCalendarDateOfRate" PopupButtonID="imgCalendarDateOfRate"
                                                ...
                                                <asp:GridView ID="gvUntiType" runat="server" AutoGenerateColumns="False" SkinID="gvNoPaging"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="New Rate" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Right"
                                                            ItemStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtNewRate" Style="width: 70px; text-align: right;" runat="server"
