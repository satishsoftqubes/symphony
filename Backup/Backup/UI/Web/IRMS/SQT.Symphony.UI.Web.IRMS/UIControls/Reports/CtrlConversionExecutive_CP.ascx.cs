...
{
    public partial class CtrlConversionExecutive_CP : System.Web.UI.UserControl
    {
        #region Variable
        ...
        {
            if (RoleRightJoinBLL.GetAccessString("RPTConversionReport_CP.aspx", new Guid(Convert.ToString(Session["UserID"]))) == "NO")
        ...
        protected void LoadReport()
        {
            try
            {
                Session.Add("ReportName", "Conversion Executive_CP");
                ...
                if (UserType.Equals("Admin"))
                    ds = ProspectsBLL.GetRptConversionExecutive_CP(channelFirm, null, startdt, enddt);
                else
                {
                    cID = (Guid)Session["UserID"];
                    ds = ProspectsBLL.GetRptConversionExecutive_CP(channelFirm, cID, startdt, enddt);
                }
