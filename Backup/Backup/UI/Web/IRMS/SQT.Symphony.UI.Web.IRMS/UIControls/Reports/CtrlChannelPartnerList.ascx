<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlChannelPartnerList.ascx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlChannelPartnerList" %>
