...
{
    public partial class CtrlLocationAnalysis : System.Web.UI.UserControl
    {
        #region Variable
        ...
        {
            if (RoleRightJoinBLL.GetAccessString("RPTLocationAnalysis.aspx", new Guid(Convert.ToString(Session["UserID"]))) == "NO")
        ...
        protected void LoadReport()
        {
            try
            {
                Session.Add("ReportName", "Location Analysis");
                ...
                if (!ddlCountry.SelectedValue.Equals(Guid.Empty.ToString()))
                {
                    cntID = ddlCountry.SelectedItem.Text.Trim();
                    Session.Add("Location", ddlCountry.SelectedItem.Text);
                }               
                ...
                ds = InvestorsUnitBLL.GetLocationAnalysisReport(propID, cntID, startdt, enddt);
