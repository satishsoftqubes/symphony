<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlLocationAnalysis.ascx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlLocationAnalysis" %>
                ...
                <td>
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">                        
                        <tr>
                         ...
                         <tr>
                            <td>
                                <asp:Literal ID="litCountry" runat="server" Text="Location"></asp:Literal>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlCountry" runat="server" >
                                <asp:ListItem Text="Region" Selected="True"></asp:ListItem>
