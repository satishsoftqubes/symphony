<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Module.aspx.cs" Inherits="SQT.Symphony.UI.Web.Configuration.Module" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="boxtopcenter">
                                                                    ...
                                                                    <div style="float:left;">
                                                                        <asp:LinkButton ID="lnkTestMolule" runat="server" OnClick="lnkTestMolule_OnClick" Text="Module"></asp:LinkButton>
                                                                    </div>
                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td style="vertical-align: top;">
                                                                                    <asp:DataList ID="dtlstModule" runat="server" RepeatColumns="5" RepeatDirection="Horizontal"
                                                                                        OnItemDataBound="dtlstModule_ItemDataBound" DataKeyField="RoleType" OnItemCommand="dtlstModule_ItemCommand">
                                                                                        <ItemTemplate>
                                                                                            <asp:Button ID="btnModuleName" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "RoleType")%>' />
                                                                                            <div class="module_subbg" runat="server" id="divOperation">
                                                                                                <div>
                                                                                                    <%--<a href="#">Setup</a>--%>
                                                                                                    <asp:LinkButton ID="lnkSetup" runat="server" Text="Setup" Enabled="false"></asp:LinkButton>
                                                                                                </div>
                                                                                                <div class="lastmodulelink">
                                                                                                    <asp:LinkButton ID="lnkOperation" runat="server" Text="Operation" Enabled="false"></asp:LinkButton>
                                                                                                    <%--<a href="#">Operation</a>--%></div>
                                                                                            </div>
                                                                                        </ItemTemplate>
                                                                                    </asp:DataList>
                                                                                    <%-- <asp:DataList ID="dtlstModule" runat="server" RepeatColumns="5" RepeatDirection="Horizontal"
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <asp:Button ID="btnModuleName" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "RoleType")%>' onmouseover="return fntest(this.id);"  onmouseout="return fntestout(this.id);"/>
                                                                                            <div class="module_subbg" runat="server" id="divOperation" style="display:none;">
                                                                                                <div><a href="#">Setup</a></div>
                                                                                                <div class="lastmodulelink"><a href="#">Operation</a></div>
                                                                                            </div>
                                                                                        </ItemTemplate>
                                                                                    </asp:DataList>--%>
                                                                                </td>
