<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlConferenceRateCard.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.Configuration.UIControls.PriceManager.CtrlConferenceRateCard" %>
...
<%@ Register Src="~/UIControls/PriceManager/CtrlRateCardCheckInDays.ascx" TagName="CtrlRateCardCheckInDays"
    TagPrefix="uc" %>
<%@ Register Src="~/UIControls/PriceManager/CtrlRateCardConferences.ascx" TagName="CtrlRateCardConferences"
    TagPrefix="uc" %>
    ...
    function fnCheckDate() {
        if (Page_ClientValidate("IsRequire")) {
            ...
            if (varDateFrom != '' && varDateTo != '') {
                ...
                var dateFrom = Date.parse(dateFrom, 'MM/dd/yyyy');
                var dateTo = Date.parse(dateTo, 'MM/dd/yyyy');
                                        ...
                                        <div id="tabs">
                                            ...
                                            <div id="tabs-1">
                                                ...
                                                <div class="content_checkbox">
                                                    <uc:CtrlRateCardConferences ID="ucConferences" runat="server"></uc:CtrlRateCardConferences>
                                                </div>
