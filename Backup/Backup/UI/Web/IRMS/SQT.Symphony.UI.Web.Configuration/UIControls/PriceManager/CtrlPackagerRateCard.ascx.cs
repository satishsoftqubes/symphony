...
{
    public partial class CtrlPackagerRateCard : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ucRateCardRoomTypes.ParentType = ucRateCardBasicInfo.ParentType = "PACKAGERATECARD";
                BindData();
                SetPageLables();

                if (clsSession.ToEditItemType != string.Empty && clsSession.ToEditItemID != Guid.Empty && clsSession.ToEditItemType.ToUpper() == "PACKAGERATECARD")
                {
        ...
        private void BindData()
        {
            try
            {
                ...
                if (lstPostingFreq.Count != 0)
                {
                    ...
                    ucRateCardServices.ddlucPostingFrequency.Items.Insert(0, new ListItem(clsCommon.GetGlobalResourceText("Common", "lblDDLSelect", "-Select-"), Guid.Empty.ToString()));
                }
                else
                {
                    ucRateCardBasicInfo.ddlucPostingFrequency.Items.Insert(0, new ListItem(clsCommon.GetGlobalResourceText("Common", "lblDDLSelect", "-Select-"), Guid.Empty.ToString()));
        ...
        {
            litMainHeader.Text = clsCommon.GetGlobalResourceText("RateCard", "lblMainHeaderPackageRateCard", "Package RateCard");
        ...
        private void BindBreadCrumb()
        {
            ...
            dr4["NameColumn"] = ucRateCardBasicInfo.ucTxtRateCardName.Trim() == string.Empty ? clsCommon.GetGlobalResourceText("BreadCrumb", "lblPackageRatecard", "Package Ratecard")  : ucRateCardBasicInfo.ucTxtRateCardName.Trim() ;
            dr4["Link"] = "";
            dt.Rows.Add(dr4);
        ...
        private void LoadRateCardData()
        {
            ...
            try
            {
                ...
                if (dsRateCardData != null)
                {
                    ...
                    if (drRateCard["PkgNoOfNight"] != null)
                        ucRateCardBasicInfo.ucTxtNoOfNights = Convert.ToString(drRateCard["PkgNoOfNight"]);
            ...
            if (Page.IsValid)
            {
                try
                {
                    ...
                    if (this.RateCardID != Guid.Empty)
                    {
                        ...
                        if (ucRateCardBasicInfo.ucTxtNoOfNights.Trim() != string.Empty)
                            objToUpdate.PkgNoOfNight = Convert.ToInt32(ucRateCardBasicInfo.ucTxtNoOfNights.Trim());
                        else
                            objToUpdate.PkgNoOfNight = null;
                        ...
                        RateCardBLL.UpdateRateCard(objToUpdate, lstRateTaxes, lstTaxesFromDB, lstRateCardDetails, lstRateCardDetailsFromDB, lstCorporates, lstCorporatesFromDB, clsSession.UserID, "ROOM",null,null);
                    ...
                    else
                    {
                        ...
                        objToInsert.RateTypeName = "PACKAGE";
                        ...
                        if (ucRateCardBasicInfo.ucTxtNoOfNights.Trim() != string.Empty)
                            objToInsert.PkgNoOfNight = Convert.ToInt32(ucRateCardBasicInfo.ucTxtNoOfNights.Trim());
