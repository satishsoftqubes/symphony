<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRoomRateCard.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.Configuration.UIControls.PriceManager.CtrlRoomRateCard" %>
...
<script language="javascript" type="text/javascript">
    ...
    function fnCheckDate() {
        if (Page_ClientValidate("IsRequire")) {
            ...
            var varDateFrom = document.getElementById('ContentPlaceHolder1_ucRoomRateCard_ucRateCardBasicInfo_txtDateFrom').value;
            var varDateTo = document.getElementById('ContentPlaceHolder1_ucRoomRateCard_ucRateCardBasicInfo_txtDateTo').value;
                ...
                <tr>
                    ...
                    <td>
                        <div class="box_form">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div style="float: right; padding-bottom: 5px;">
                                            ...
                                            <asp:Button Visible="false" ID="btnTopCancel" Style="float: right; margin-left: 5px;"
                                                runat="server" ImageUrl="~/images/cancle.png" CausesValidation="false" OnClick="btnCancel_OnClick" />
                                            <asp:Button ID="btnTopSave" Style="float: right; margin-left: 5px;" runat="server"
                                                ImageUrl="~/images/save.png" ValidationGroup="IsRequire" CausesValidation="true"
                                                OnClientClick="return fnCheckDate();" OnClick="btnSave_OnClick" />
                                            <asp:Button ID="btnTopBackToList" Style="float: right; margin-left: 5px;" runat="server"
                                            ...
                                            <tr>
                                                <td width="40%" align="left" style="vertical-align: top; border-right: 1px solid gray;">
                                                    <div style="float: right; width: auto; display: inline-block;">
                                                        <asp:LinkButton ID="lnkCalculateTax" runat="server" Text="Calculate Tax" OnClick="lnkCalculateTax_Click"></asp:LinkButton>
                                                    </div>
                            ...
                            <asp:UpdatePanel ID="updRoomRateCard" runat="server">
                                <ContentTemplate>
                                    <div style="padding-top: 10px; margin-top: 15px; float: right; width: auto; display: inline-block;">
                                        <asp:Button Visible="false" ID="btnCancel" Style="float: right; margin-left: 5px;"
                                            runat="server" ImageUrl="~/images/cancle.png" CausesValidation="false" OnClick="btnCancel_OnClick" />
                                        <asp:Button ID="btnSave" Style="float: right; margin-left: 5px;" runat="server" ImageUrl="~/images/save.png"
                                            ValidationGroup="IsRequire" CausesValidation="true" OnClientClick="return fnCheckDate();"
                            ...
                            <asp:UpdateProgress AssociatedUpdatePanelID="updRoomRateCard" ID="UpdateProgressRoomRateCard"
                                runat="server">
                                <ProgressTemplate>
                                    <div id="progressBackgroundFilter">
                                    </div>
