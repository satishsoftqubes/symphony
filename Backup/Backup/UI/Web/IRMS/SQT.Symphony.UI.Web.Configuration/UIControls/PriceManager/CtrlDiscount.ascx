<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlDiscount.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.Configuration.UIControls.PriceManager.CtrlDiscount" %>
<%@ Register Src="~/UIControls/CommonControls/MsgBox.ascx" TagName="MsgBox" TagPrefix="uc1" %>
<%@ Register Src="~/UIControls/PriceManager/CtrlAddEditDiscount.ascx" TagName="CtrlAddEditDiscount"
    TagPrefix="uc" %>
    ...
    <script>
        function pageLoad(sender, args) {
            ...
            $(document).ready(function () {
                $("#<%= txtSrchDiscountName.ClientID %>").autocomplete('../PriceManager/DiscountAutoComplete.ashx');
            });
        }
</script>
<asp:UpdatePanel ID="updDepartment" runat="server">
    <ContentTemplate>
                            ...
                            <td align="left">
                                <div class="box_form">
                                    <table cellpadding="2" cellspacing="2" width="100%">
                                        ...
                                        <tr>
                                            <th align="left">
                                                <asp:Literal ID="litSearchDiscountName" runat="server"></asp:Literal>
                                            </th>
                                            <td style="width: 290px">
                                                <asp:TextBox ID="txtSrchDiscountName" runat="server" MaxLength="70"></asp:TextBox>
                                            </td>
                                            <th align="left">
                                                <asp:Literal ID="litSearchDiscountType" runat="server"></asp:Literal>
                                            </th>
                                            <td style="width: 290px">
                                                <asp:DropDownList ID="ddlSearchDiscountType" runat="server">
                                                </asp:DropDownList>
                                                <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="~/images/search-icon.png"
                                                    Style="border: 0px; margin: -1px 0 0 5px; vertical-align: middle;" OnClick="btnSearch_Click" OnClientClick="fnDisplayCatchErrorMessage();" />
                                        ...
                                        <tr>
                                            <td colspan="5">
                                                <div class="box_head">
                                                    <span>
                                                        <asp:Literal ID="litDiscountList" runat="server"></asp:Literal></span></div>
                                                <div class="clear">
                                                </div>
                                                <div class="box_content">
                                                    <asp:GridView ID="gvDiscountList" runat="server" AutoGenerateColumns="false" Width="100%"
                                                        ShowHeader="true" OnRowCommand="gvDiscountList_RowCommand" OnRowDataBound="gvDiscountList_RowDataBound"
                                                        OnPageIndexChanging="gvDiscountList_PageIndexChanging">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                                <HeaderTemplate>
                                                                    <asp:Literal ID="litGvHdrDiscountName" runat="server"></asp:Literal>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDiscountName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "DiscountName")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="120px" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "DiscountRate")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="200px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                                <HeaderTemplate>
                                                                    <asp:Literal ID="litGvHdrDiscountTypeName" runat="server"></asp:Literal>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDiscountTypeName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "DiscountTypeName")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="50px">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "DiscountID")%>'
                                                                        CommandName="EDITDATA" OnClientClick="fnDisplayCatchErrorMessage();"><img src="../../images/file.png" /></asp:LinkButton>
                                                                    <%--<asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "DiscountID")%>'
                                                                        CommandName="DELETEDATA"><img src="../../images/delete.png" /></asp:LinkButton>--%>
                                                                    <asp:LinkButton ID="lnkDelete" runat="server" ><img src="../../images/delete.png" /></asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                        <EmptyDataTemplate>
        ...
        <uc:CtrlAddEditDiscount ID="ucAddEditDiscount" runat="server" OnbtnCallParent_Click="btnCallParent_Click" />
