...
{
    public partial class CtrlGDSRateCard : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (clsSession.ToEditItemType != string.Empty && clsSession.ToEditItemID != Guid.Empty && clsSession.ToEditItemType.ToUpper() == "GDSRATECARD")
                {
        ...
        private void BindBreadCrumb()
        {
            ...
            dr4["NameColumn"] = ucRateCardBasicInfo.ucTxtRateCardName.Trim() == string.Empty ? clsCommon.GetGlobalResourceText("BreadCrumb", "lblGDSRatecard", "GDS Ratecard")  : ucRateCardBasicInfo.ucTxtRateCardName.Trim() ;
            dr4["Link"] = "";
            dt.Rows.Add(dr4);
        ...
        {
            litMainHeader.Text = clsCommon.GetGlobalResourceText("RateCard", "lblMainHeaderGDSRateCard", "GDS RateCard");
