...
namespace SQT.Symphony.UI.Web.BackOffice.UIControls.CommonControls
{
    public partial class CtrlUserSetting : System.Web.UI.UserControl
    {
        ...
        private void BindBreadCrumb()
        {
            ...
            dr3["NameColumn"] = "User Setting";// clsCommon.GetGlobalResourceText("BreadCrumb", "lblAccountGroupSetup", "Account Group");
            dr3["Link"] = "";
            dt.Rows.Add(dr3);
        ...
        {
            ltrMainHeader.Text = "SETTING"; //clsCommon.GetGlobalResourceText("UserSettings", "lblMainHeader", "SETTING");
            lblHeaderChangeDisplayName.Text = "Change Display Name"; // clsCommon.GetGlobalResourceText("UserSettings", "lblHeaderChangeDisplayName", "Change Display Name");
            ltrDisplayName.Text = "Display Name"; // clsCommon.GetGlobalResourceText("UserSettings", "lblDisplayName", "Display Name");
            lnkChangeDisplayName.Text = "Change"; //clsCommon.GetGlobalResourceText("UserSettings", "lblBtnChangeDisplayName", "Change");
            lblHeaderChangePassword.Text = "Change Password"; //clsCommon.GetGlobalResourceText("UserSettings", "lblHeaderChangePassword", "Change Password");
            ltrPassword.Text = "Password"; //clsCommon.GetGlobalResourceText("UserSettings", "lblPassword", "Password");
            lnkChangePassword.Text = "Change"; //clsCommon.GetGlobalResourceText("UserSettings", "lblBtnChangePassword", "Change");
            ltrHeaderChangeDisplayName.Text = "Change Display Name"; //clsCommon.GetGlobalResourceText("UserSettings", "lblPopupHeaderChangeDisplayName", "Change Display Name");
            ltrUserDisplayName.Text = "Display Name"; //clsCommon.GetGlobalResourceText("UserSettings", "lblDisplayName", "Display Name");
            btnSaveDisplayName.Text = btnSavePassword.Text = "Update"; //clsCommon.GetGlobalResourceText("Common", "lblBtnUpdate", "Update");
            btnCancelChangeDisplayName.Text = btnCancelChangePassword.Text = "Cancel"; //clsCommon.GetGlobalResourceText("Common", "lblBtnCancel", "Cancel");
            ltrHeaderChangePassword.Text = "Change Password"; //clsCommon.GetGlobalResourceText("UserSettings", "lblPopupHeaderChangePassword", "Change Password");
            ltrCurrentPassword.Text = "Current Password"; //clsCommon.GetGlobalResourceText("UserSettings", "lblCurrentPassword", "Current Password");
            ltrNewPassword.Text = "New Password"; //clsCommon.GetGlobalResourceText("UserSettings", "lblNewPassword", "New Password");
            ltrRepeatPassword.Text = "Repeat Password"; //clsCommon.GetGlobalResourceText("UserSettings", "lblRepeatPassword", "Repeat Password");
            cmpvRepeatPassword.Text = "Repeat Password should be same as New Password."; //clsCommon.GetGlobalResourceText("UserSettings", "lblMsgNewAndRepeatPwdShouldbeSame", "Repeat Password should be same as New Password.");
            litGeneralMandartoryFiledMessageForDisplayName.Text = litGeneralMandartoryFiledMessageForPassword.Text = "All Bold Fields are Mandatory"; //clsCommon.GetGlobalResourceText("CommonMessage", "lblGeneralMandartoryFiledMessage", "All Bold Fields are Mandatory");
        }
        #endregion
