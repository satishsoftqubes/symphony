...
{
    public partial class CtrlCancellationCharges : System.Web.UI.UserControl
    {
        #region Variable
        ...
        protected void LoadReport()
        {
            try
            {
                Session.Add("ReportName", "Cancellation Charges");
                ...
                ds = BookKeepingBLL.GetRPTCancellationCharges(clsSession.CompanyID, clsSession.PropertyID, iGstNm, startdt, enddt);
