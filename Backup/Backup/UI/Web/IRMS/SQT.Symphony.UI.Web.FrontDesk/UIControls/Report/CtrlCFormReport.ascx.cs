...
{
    public partial class CtrlCFormReport : System.Web.UI.UserControl
    {
        #region Variable
        ...
        protected void LoadReport()
        {
            try
            {
                Session.Add("ReportName", "C-Form Report");
                ...
                ds = ForeignNationalInfoBLL.RPTCFormReport(clsSession.CompanyID, clsSession.PropertyID,startdt, enddt);
