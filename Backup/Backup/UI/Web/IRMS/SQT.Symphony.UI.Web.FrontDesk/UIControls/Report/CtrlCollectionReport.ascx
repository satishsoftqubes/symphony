<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlCollectionReport.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Report.CtrlCollectionReport" %>
                    ...
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">
                        ...
                        <tr>
                            <td align="left" valign="top">
                                <asp:Literal ID="litPaymentMode" runat="server" Text="Payment Mode"></asp:Literal>
                            </td>
                            <td>
                                ...
                                <%--<div style="float: left; width:100%;">
                                    <asp:CheckBox ID="chkAll" runat="server" Text="ALL" AutoPostBack="true" 
                                        Style="float: left; margin-left: 5px;" oncheckedchanged="chkAll_CheckedChanged"  />
                                    <asp:CheckBox ID="chkCash" runat="server" Text="Cash" AutoPostBack="true" Style="float: left; margin-left: 5px;"  oncheckedchanged="chkAll_CheckedChanged"  />
                                    <asp:CheckBox ID="chkCheque" runat="server" Text="Cheque" AutoPostBack="true" Style="float: left; margin-left: 5px;"  oncheckedchanged="chkAll_CheckedChanged"   />
                                    <asp:CheckBox ID="chkCard" runat="server" Text="Credit Card" AutoPostBack="true" Style="float: left; margin-left: 5px;"  oncheckedchanged="chkAll_CheckedChanged"   />
                                </div>--%>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" style="width: 100px;">
                                <asp:Literal ID="litGeneralIDTermType" runat="server" Text="Ledger Acct"></asp:Literal>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlGeneralIDType" runat="server">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" style="width: 100px;">
                                <asp:Literal ID="ltCounter" runat="server" Text="Counter"></asp:Literal>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="float: Left;">                                    
                                    <asp:Button ID="btnPreview" Text="View" Style="float: left; margin-left: 5px;"
