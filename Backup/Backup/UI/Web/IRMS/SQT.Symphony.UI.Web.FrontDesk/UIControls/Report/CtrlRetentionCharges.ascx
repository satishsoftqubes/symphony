<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRetentionCharges.ascx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Report.CtrlRetentionCharges" %>
                    ...
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">                                                
                       <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlGuestName" runat="server" ></asp:DropDownList>
                            </td>
                        </tr>                                              
                        <tr>
                            <td>
