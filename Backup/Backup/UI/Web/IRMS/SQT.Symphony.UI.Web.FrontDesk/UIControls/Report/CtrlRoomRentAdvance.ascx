<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRoomRentAdvance.ascx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Report.CtrlRoomRentAdvance" %>
                    ...
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">                                                
                       <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCounter" runat="server" ></asp:DropDownList>
                            </td>
                        </tr>
                         <tr>
                            <td align="left" valign="top" style="width: 100px;">
                                <asp:Literal ID="ltCashier" runat="server" Text="Cashier"></asp:Literal>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlCashier" runat="server" ></asp:DropDownList>
                            </td>
                        </tr>  
                          <tr>
                            <td align="left" valign="top" style="width: 100px;">
