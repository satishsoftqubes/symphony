<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlCompanyPosting.ascx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Report.CtrlCompanyPosting" %>
