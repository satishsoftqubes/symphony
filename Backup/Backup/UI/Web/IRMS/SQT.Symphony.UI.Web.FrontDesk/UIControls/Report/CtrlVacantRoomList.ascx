<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlVacantRoomList.ascx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Report.CtrlVacantRoomList" %>
                    ...
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">                                                
                         <tr>
                            <td style="width:100px;">
                                <asp:Literal ID="litStartDate" runat="server" Text="Date"></asp:Literal>
                            </td>
                            <td>
                         ...
                         <tr style="visibility:hidden;">
                            <td align="left" valign="top" style="width: 100px;">
                                <asp:Literal ID="ltCounter" runat="server" Text="Room Type"></asp:Literal>
                            </td>
                            <td>
