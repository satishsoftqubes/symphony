<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRoomStatus.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Reservation.CtrlRoomStatus" %>
                                    ...
                                    <asp:MultiView ID="mvBlockRoom" runat="server">
                                        <asp:View ID="vBlockRoomList" runat="server">
                                            <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img src="../../images/clear.png" id="imgSearchSD" style="vertical-align: middle;"
                                                            title="<%= strClearDateTooltip %>" onclick="fnClearDate1('<%= txtSearchSD.ClientID %>');" />
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To &nbsp;&nbsp;
                                                        ...
                                                        <img src="../../images/clear.png" id="img3" style="vertical-align: middle;" title="<%= strClearDateTooltip %>"
                                                            onclick="fnClearDate1('<%= txtSearchED.ClientID %>');" />
                                                ...
                                                <tr>
                                                    <td colspan="4" align="right" valign="middle">
                                                        <asp:Button ID="btnEnableBlockRoom" runat="server" Style="display: inline;" OnClientClick="return ValidateBlockRoom();"
                                                            OnClick="btnEnableBlockRoom_Click" />&nbsp;&nbsp;&nbsp;
                                                        <asp:Button ID="btnAddBottomBlockRoom" runat="server" Style="float: right; display: inline;"
                                                            OnClick="btnAddTopBlockRoom_Click" OnClientClick="fnDisplayCatchErrorMessage();" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:View>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img src="../../images/clear.png" id="img1" style="vertical-align: middle;" title="<%= strClearDateTooltip %>"
                                                            onclick="fnClearDate1('<%= txtEndDate.ClientID %>');" />
                                                        <span>
