<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlGDSRateCard.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.Configuration.UIControls.PriceManager.CtrlGDSRateCard" %>
...
<script language="javascript" type="text/javascript">
    ...
    function fnCheckDate() {
        if (Page_ClientValidate("IsRequire")) {
            ...
            var varDateFrom = document.getElementById('ContentPlaceHolder1_ucGDSRateCard_ucRateCardBasicInfo_txtDateFrom').value;
            var varDateTo = document.getElementById('ContentPlaceHolder1_ucGDSRateCard_ucRateCardBasicInfo_txtDateTo').value;
