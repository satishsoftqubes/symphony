...
{
    public partial class CtrlRoomRateCard : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (clsSession.ToEditItemType != string.Empty && clsSession.ToEditItemID != Guid.Empty && clsSession.ToEditItemType.ToUpper() == "ROOMRATECARD")
                {
        ...
        private void BindBreadCrumb()
        {
            ...
            dr4["NameColumn"] = ucRateCardBasicInfo.ucTxtRateCardName.Trim() == string.Empty ? clsCommon.GetGlobalResourceText("BreadCrumb", "lblRoomRatecard", "Room Ratecard") : ucRateCardBasicInfo.ucTxtRateCardName.Trim();
            dr4["Link"] = "";
            dt.Rows.Add(dr4);
        ...
        {
            litMainHeader.Text = clsCommon.GetGlobalResourceText("RateCard", "lblMainHeaderRoomRateCard", "Room RateCard");
            //litTabBasicInformation.Text = "Settings"; clsCommon.GetGlobalResourceText("RateCard", "lblTabBasicInformation", "Basic Information");
            //litTabTermsAndConditions.Text = clsCommon.GetGlobalResourceText("RateCard", "lblTabTermsAndConditions", "Term & Condition");
            btnTopSave.Text = btnSave.Text = clsCommon.GetGlobalResourceText("Common", "lblBtnSave", "Save");
            btnTopCancel.Text = btnCancel.Text = clsCommon.GetGlobalResourceText("Common", "lblBtnCancel", "Cancel");
            ...
            btnTopBackToList.Text = btnBackToList.Text = clsCommon.GetGlobalResourceText("Common", "lblbtnBackToList", "Back to List");
        ...
        private void BindTaxGrid()
        {
            ...
            //DataSet dsTaxData = AccountBLL.SelectTaxData(clsSession.PropertyID, clsSession.CompanyID, DateTime.Now);

            //if (dsTaxData.Tables.Count > 0 && dsTaxData.Tables[0].Rows.Count > 0)
            //{
            //    ucRateCardTaxes.gvucTaxes.DataSource = dsTaxData.Tables[0];
            //    ucRateCardTaxes.gvucTaxes.DataBind();
            //}
            //else
            //{
        ...
        private void LoadRateCardData()
        {
            ...
            try
            {
                ...
                if (dsRateCardData != null)
                {
                    ...
                    if (drRateCard["IsStandard"] != null && Convert.ToBoolean(drRateCard["IsStandard"]) == true)
                        ucRateCardBasicInfo.rdblucRateCardType = "STANDARD";
                    else
                        ucRateCardBasicInfo.rdblucRateCardType = "SPECIAL";
                    ...
                    DataSet dsRateCardResStatusCount = RateCardBLL.GetForRoomRateCardResStatus(clsSession.PropertyID, clsSession.CompanyID, this.RateCardID);

                    if (dsRateCardResStatusCount != null)
                    {
                        if (Convert.ToInt32(dsRateCardResStatusCount.Tables[0].Rows[0]["ReservationCount"].ToString()) != 0)
                        {
                            ucRateCardTaxes.gvucTaxes.Enabled = false;
                            ucRateCardRoomTypes.gvucRoomTypes.Enabled = false;
                        }
                        else
                        {
                            ucRateCardTaxes.gvucTaxes.Enabled = true;
                            ucRateCardRoomTypes.gvucRoomTypes.Enabled = true;
                        }
                    }
        ...
        private void ClearControls()
        {
            ...
            ucRateCardBasicInfo.ucChkIsPerRoom = false;
            ucRateCardBasicInfo.ucTxtRetentionCharge = "";
            ...
            if (Page.IsValid)
            {
                try
                {
                    ...
                    if (this.RateCardID != Guid.Empty)
                    {
                        ...
                        objToUpdate.IsStandard = true; //Convert.ToString(ucRateCardBasicInfo.rdblucRateCardType).ToUpper() == "STANDARD";
                        ...
                        //    }
                        //}
                        objToUpdate.IsCheckInMonday = objToUpdate.IsCheckInTuesday = objToUpdate.IsCheckInWednesday = objToUpdate.IsCheckInThursday = objToUpdate.IsCheckInFriday = objToUpdate.IsCheckInSaturday = objToUpdate.IsCheckInSunday = true;
                        ...
                        RateCardBLL.UpdateRateCard(objToUpdate, lstRateTaxes, lstTaxesFromDB, lstRateCardDetails, lstRateCardDetailsFromDB, lstCorporates, lstCorporatesFromDB, clsSession.UserID, "ROOM", dtInsertData, null);
                    ...
                    else
                    {
                        ...
                        objToInsert.IsStandard = true; //Convert.ToString(ucRateCardBasicInfo.rdblucRateCardType).ToUpper() == "STANDARD";
        ...
        protected void ddlDiscountType_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                ////RangeValidator rngvDiscountCharges = (RangeValidator)row.FindControl("rngvDiscountCharges");
