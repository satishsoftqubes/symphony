<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlManageResourceFile.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.Configuration.UIControls.Configurations.CtrlManageResourceFile" %>
