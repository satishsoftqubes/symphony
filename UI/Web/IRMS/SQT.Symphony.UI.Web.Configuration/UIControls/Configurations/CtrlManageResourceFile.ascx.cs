...
{
    public partial class CtrlManageResourceFile : System.Web.UI.UserControl
    {
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                /********************
                string strPath = Server.MapPath("/App_GlobalResources/" + this.HotelCode.Replace("-", "_") + "_" + this.ResourceFileName);
                
                Hashtable resourceEntries = new Hashtable();

                //Get existing resources
                ResourceReader reader = new ResourceReader(strPath);
                if (reader != null)
                {
                ...
                {
                    Label lblElement = (Label)gvResourceElements.Rows[i].FindControl("lblResourceElementName");
                    TextBox txtValue = (TextBox)gvResourceElements.Rows[i].FindControl("txtValue");
                    ht.Add(Convert.ToString(lblElement.Text), txtValue.Text.Trim());
                }
                ...
                IResourceWriter resourceWriter = new ResourceWriter(strPath);
                ...
                //////SQT.Symphony.UI.Web.Configuration.Class.ResXResourceWriter resourceWriter = new SQT.Symphony.UI.Web.Configuration.Class.ResXResourceWriter();
