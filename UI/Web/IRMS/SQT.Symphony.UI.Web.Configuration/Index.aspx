<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SQT.Symphony.UI.Web.Configuration.Index" %>
        ...
        <ContentTemplate>
                            ...
                            <td class="loginbox_bg">
                                <asp:Panel ID="pnlLogin" runat="server" DefaultButton="btnLogin">
                                    <div class="loginbox_content" style="width: 280px;">
                                        ...
                                        <br />
                                        <span>
                                            <asp:Literal ID="litHotel" runat="server"></asp:Literal></span><br />
                                        <asp:DropDownList ID="ddlProperty" runat="server" Style="width: 245px; height: 25px;">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rvfDepartmentName" InitialValue="00000000-0000-0000-0000-000000000000"
                                            ...
                                            ValidationGroup="IsRequire" ControlToValidate="ddlProperty" Display="Dynamic">
                                        </asp:RequiredFieldValidator>
                                        <%--<asp:TextBox ID="txtHotelCode" runat="server" MaxLength="4" Style="width: 245px; height: 25px;" />
                                    ...
                                    <div style="padding-left: 25px;">
                                        <asp:Button ID="btnLogin" Style="outline: none; float: left;" runat="server" CssClass="button1"
                                            OnClick="btnLogin_OnClick" ValidationGroup="IsRequire" CausesValidation="true" />
                                        <asp:Button ID="btnCancel" Style="outline: none; float: left; margin-left: 10px"
                                            CssClass="button1" OnClick="btnCancel_OnClick" CausesValidation="true" runat="server" />
                                    </div>
            ...
            <div>
                <ajx:ModalPopupExtender ID="mpeMessage" runat="server" TargetControlID="hfMessage"
                    PopupControlID="pnlMessage" BackgroundCssClass="mod_background" CancelControlID="btnOk">
