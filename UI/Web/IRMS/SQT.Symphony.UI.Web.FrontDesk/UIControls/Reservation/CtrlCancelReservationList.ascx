<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlCancelReservationList.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Reservation.CtrlCancelReservationList" %>
...
<asp:UpdatePanel ID="updCancelReservationList" runat="server">
    <ContentTemplate>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="boxtopcenter">
                                <asp:Literal ID="litMainHeader" runat="server" Text="Cancel Reservation"></asp:Literal>
                            </td>
                                    ...
                                    <table cellpadding="2" cellspacing="2" border="0">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:ImageButton ID="imgbtnClearSearch" runat="server" ImageUrl="~/images/clearsearch.png" ToolTip="Reset"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField ItemStyle-Width="60px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkReservationNo" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ReservationNo")%>'
                                                                        CommandName="CANCELLATION" CommandArgument='<%# Container.DataItemIndex %>'></asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
        ...
        <ajx:ModalPopupExtender ID="mpeOpenAmendment" runat="server" TargetControlID="hdnAmendment"
            PopupControlID="pnlAmendment" BackgroundCssClass="mod_background" CancelControlID="imbCloseAmendmentPopup">
            ...
            <div class="box_col1">
                <div class="box_head">
                    ...
                    <div style="float: right; display: inline; padding-top: 12px; padding-right: 10px;">
                        <asp:ImageButton ID="imbCloseAmendmentPopup" runat="server" ImageUrl="~/images/closepopup.png"
...
<asp:UpdateProgress AssociatedUpdatePanelID="updCancelReservationList" ID="UpdateProgressCancelList"
    runat="server">
    <ProgressTemplate>
