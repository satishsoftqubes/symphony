<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlAvailabilityByFloor.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Reservation.CtrlAvailabilityByFloor" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="boxtopcenter">
                                <asp:Literal ID="litMainHeader" runat="server" Text="Availability By Floor"></asp:Literal>
                            </td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="box_head">
                                                    <span>
                                                        <asp:Literal ID="litAvailabilityByBlock" runat="server" Text="Availability By Floor"></asp:Literal>
                                                    </span>
                                                </div>
                                                <div class="clear">
                                                </div>
                                                <div class="box_content">
                                                    <asp:GridView ID="gvAvailabilityByFloor" runat="server" AutoGenerateColumns="false"
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    ...
                                                                    <div style="float: left; width: 368px; border-right: 1px solid #ccc; padding-left: 1px;">
                                                                        <asp:Literal ID="litGvHdrBlockType" runat="server" Text="Block Name"></asp:Literal>
                                                                    </div>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <div id="dvGR<%# Container.DataItemIndex %>" style="display: block; width: 100%;
                                                                        float: left;">
                                                                        <div class="box_content">
                                                                            <asp:GridView ID="gvInnerGridAvaiByFloorList" runat="server" Width="100%" ShowHeader="true"
                                                                                AutoGenerateColumns="false">
                                                                                <Columns>
                                                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                                                        <HeaderTemplate>
                                                                                            <asp:Label ID="lblGvHdrFloorNo" runat="server" Text="Floor No."></asp:Label>
                                                                                        </HeaderTemplate>
                                                                                        <ItemTemplate>
