<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlCashCardList.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Guest.CtrlCashCardList" %>
                                    ...
                                    <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                        <tr>
                                            <td>
                                                <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Literal ID="litCashCardNo" runat="server" Text="Cash card"></asp:Literal>
                                                        </td>
                                                        <td width="170px">
                                                            <asp:TextBox ID="txtCashCard" runat="server" Style="width: 140px !important;" SkinID="searchtextbox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="box_head">
                                                    <span>
                                                        <asp:Literal ID="litAddOnServicesGuestList" runat="server" Text="Guest List"></asp:Literal>
                                                    </span>
                                                </div>
                                                <div class="clear">
                                                </div>
                                                    ...
                                                    <asp:GridView ID="gvGuestListAddOnServices" runat="server" AutoGenerateColumns="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReservationNo" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ReservationNo")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblGuestName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "GuestFullName")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField ItemStyle-Width="125px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblGvHdrCashCardType" runat="server" Text="Cash Card No"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <%#DataBinder.Eval(Container.DataItem, "Cashcard_Number")%>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
