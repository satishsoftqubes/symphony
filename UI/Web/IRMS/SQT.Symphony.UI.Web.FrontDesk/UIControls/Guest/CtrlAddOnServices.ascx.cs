...
{
    public partial class CtrlAddOnServices : System.Web.UI.UserControl
    {
        ...
        private void BindGrid()
        {
            try
            {
                ...
                DataSet dsReservationData = ResAddOnServiceListBLL.GetCurrentGuestListDataAddOnServices(null, clsSession.PropertyID, clsSession.CompanyID, strName, strMobileNo, strReservationNo, strRoomNo, BillingInstructionID,null);
        ...
        {
            Response.Redirect("~/GUI/Guest/SearchServices.aspx");
        }
        ...
        protected void gvGuestListAddOnServices_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.Equals("GUESTPROFILE"))
                {
                    ...
                    Session["ReservationIdForAddOnService"] = strAddonserviceinfo[1];
                    Session["FolioIDForAddOnService"] = strAddonserviceinfo[2];
                    Session["GuestIDForAddOnService"] = strAddonserviceinfo[3];
                    Response.Redirect("~/GUI/Guest/AddServices.aspx");
                }
                else if (e.CommandName.Equals("CASHCARD"))
                {
                    string[] strAddonserviceinfo = Convert.ToString(e.CommandArgument).Split(',');
                    ...
                    lblBookingNo.Text = ((LinkButton)row.FindControl("lnkReservationNo")).Text;
                    lblGuestName.Text = ((LinkButton)row.FindControl("lnkGuestName")).Text;
