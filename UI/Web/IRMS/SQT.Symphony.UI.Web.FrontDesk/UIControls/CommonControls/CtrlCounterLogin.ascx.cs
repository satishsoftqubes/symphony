                ...
                if (clsSession.UserID != Guid.Empty)
                {
                    ...
                    if (dtUserCounterDetails.Tables[0].Rows.Count != 0)
                    {
                        ...
                        else
                        {
                            ...
                            if (Convert.ToString(dtUserCounterDetails.Tables[0].Rows[0]["LogInDate"]) != string.Empty)
                                litDspDetailLoginTime.Text = Convert.ToDateTime(Convert.ToString(dtUserCounterDetails.Tables[0].Rows[0]["LogInDate"])).ToString(clsSession.DateFormat + " " + clsSession.TimeFormat);
