<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRoomDeposit.ascx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Report.CtrlRoomDeposit" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="float: Left;">
                                    ...
                                    <asp:Button ID="btnPreview" Text="Preview" Style="float: left; margin-left: 5px;"
