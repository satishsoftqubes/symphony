<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlOccupancyChartByBlockAndRoomType.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Report.CtrlOccupancyChartByBlockAndRoomType" %>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="box">
            <tr>
                ...
                <td class="boxtopcenter">
                    Occupancy Report - Block & Room Type
                </td>
                ...
                <td>
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:LinkButton ID="lbkbtnRateCard" runat="server" Text="Occupancy Report - RoomType"
                                    OnClick="lbkbtnRateCard_Click"></asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
