<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRevenueDetail.ascx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Report.CtrlRevenueDetail" %>
