<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlCancellationCharges.ascx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.UIControls.Report.CtrlCancellationCharges" %>
