<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRoomHistory.ascx.cs" Inherits="SQT.Symphony.UI.Web.FrontDesk.ReportFiles.CtrlRoomHistory" %>
                       ...
                       <tr>
                        ...
                        <tr>
                            <td align="left" valign="top" style="width: 100px;">
                                <asp:Literal ID="litRoom" runat="server" Text="Room"></asp:Literal>
                            </td>
                            <td>
