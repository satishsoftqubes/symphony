<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckInVoucher.aspx.cs"
    Inherits="SQT.Symphony.UI.Web.FrontDesk.GUI.Reservation.CheckInVoucher" %>
...
<body>
    <form id="form1" runat="server">
     <asp:ScriptManager ID="srcptCheckInVoucher" runat="server" EnablePageMethods="true">
    </asp:ScriptManager>
