<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlConversionReport_RefThrough.ascx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlConversionReport_RefThrough" %>
                    ...
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">
                        <tr>
                            <td align="left" valign="top" style="width: 120px;">
                                <asp:Literal ID="litRefThrough" runat="server" Text="Reference Through"></asp:Literal>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlReferenceThrough" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" style="width: 120px;">
                                <asp:Literal ID="litName" runat="server" Text="Reference Name"></asp:Literal>
                            </td>
                            <td>
                                <asp:TextBox ID="txtReferenceName" runat="server"></asp:TextBox>
                            </td>
                        </tr>                       
                       <tr>
                            <td>
