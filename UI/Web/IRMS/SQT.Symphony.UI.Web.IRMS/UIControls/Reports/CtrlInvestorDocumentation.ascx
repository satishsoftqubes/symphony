<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlInvestorDocumentation.ascx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlInvestorDocumentation" %>
