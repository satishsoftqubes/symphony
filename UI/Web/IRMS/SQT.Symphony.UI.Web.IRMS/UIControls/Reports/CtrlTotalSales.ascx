<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTotalSales.ascx.cs" Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlTotalSales" %>
                ...
                <td>
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">                        
                        <tr>
                         ...
                         <tr>
                            <td align="left" valign="top" style="width: 100px;">
                                <asp:Literal ID="litRefThrow" runat="server" Text="Reference Through"></asp:Literal>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlReferenceThrow" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
