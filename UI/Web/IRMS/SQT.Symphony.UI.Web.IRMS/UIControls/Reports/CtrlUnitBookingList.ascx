<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlUnitBookingList.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Reports.CtrlUnitBookingList" %>
                    ...
                    <table width="100%" cellpadding="3" cellspacing="2" style="background-color: #fff;">
                        <tr>
                            <td align="left" valign="top" style="width: 100px;">
                                <asp:Literal ID="litBlock" runat="server" Text="Block"></asp:Literal>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Literal ID="litFloor" runat="server" Text="Floor"></asp:Literal>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlInvestor" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlInvestor_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Literal ID="litUnit" runat="server" Text="Unit"></asp:Literal>
                            </td>
                            <td>
