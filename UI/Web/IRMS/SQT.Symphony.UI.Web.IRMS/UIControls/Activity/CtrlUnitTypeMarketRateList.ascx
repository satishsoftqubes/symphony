<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlUnitTypeMarketRateList.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Activity.CtrlUnitTypeMarketRateList" %>
                                    ...
                                    <tr>
                                        <td colspan="6" style="padding: 15px;">
                                            <div class="demo">
                                                <div id="tabs">
                                                    <ul>
                                                        <li><a href="#tabs-1">View Price</a></li>
                                                        <li><a href="#tabs-2" style="display: none;">View Graph</a></li>
                                                    </ul>
                                                    <div id="tabs-1">
                                                        <table cellpadding="2" cellspacing="0" width="100%" border="0">
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <%--<div style="overflow: auto; width: 650px;">
                                                                        <asp:Chart OnCustomize="mstChartPosition_Customize" ID="mstChartPosition" runat="server"
                                                                            BorderlineColor="#E8E9EA" BorderlineWidth="1" BorderlineDashStyle="Solid">
                                                                            <Series>
                                                                                <asp:Series Name="Series1" LabelAngle="90" Legend="Legend1" ChartType="Column">
                                                                                </asp:Series>
                                                                            </Series>
                                                                            <ChartAreas>
