...
{
    public partial class CtrlRentPayout : System.Web.UI.UserControl
    {
                    ...
                    if (Request["Qtr"] != null)
                    {
                        ...
                        if (this.QuarterID.ToString().ToUpper() == "447A57B9-3075-44F0-B740-64128DD470B3")
                        {
                            if (Request["Val"] != null && Convert.ToString(Request["Val"]).ToUpper() == "TRUE")
                                Response.Redirect("~/Applications/Activity/RentPayoutQuarterTwo.aspx?Val=True&Qtr=447a57b9-3075-44f0-b740-64128dd470b3");
                            else
                                Response.Redirect("~/Applications/Activity/RentPayoutQuarterTwo.aspx?Qtr=447a57b9-3075-44f0-b740-64128dd470b3");
                        }
