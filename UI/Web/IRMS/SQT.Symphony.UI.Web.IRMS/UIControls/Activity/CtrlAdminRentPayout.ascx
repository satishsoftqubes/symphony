<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlAdminRentPayout.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Activity.CtrlAdminRentPayout" %>
                                                                ...
                                                                <table border="0" cellpadding="2" cellspacing="2" width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right; border-bottom: 1px solid #ccccce;">
                                                                            <asp:TextBox ID="txtRoomRentCollectedForPeriod" runat="server" MaxLength="18" Style="width: 80px;
                                                                                text-align: right" OnTextChanged="txtRoomRentCollectedForPeriod_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                            <ajx:FilteredTextBoxExtender ID="fteDisplayRoomRentForPeriod" runat="server" TargetControlID="txtRoomRentCollectedForPeriod"
                                                                                ValidChars="0123456789" FilterMode="ValidChars">
                                                                            </ajx:FilteredTextBoxExtender>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right; border-bottom: 1px solid #ccccce;">
                                                                            <asp:Literal ID="litRoomRentTodistribute" runat="server"></asp:Literal>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding-left: 10px; border-bottom: 1px solid #ccccce;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-left: 10px; border-bottom: 1px solid #ccccce;">
                                                                            <b>K)</b>
                                                                            <asp:Literal ID="litRentToDistributed" Text=" Net amount to be distribute&nbsp;<b>(I + J)</b>"
                                                                                runat="server"></asp:Literal>
                                                                        </td>
                                                                        <td style="text-align: right; border-bottom: 1px solid #ccccce;">
                                                                            <asp:Literal ID="litNetAmountToDistributed" runat="server"></asp:Literal>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding-left: 10px; border-bottom: 1px solid #ccccce;">
                                                                            <b>L)</b>
                                                                            <asp:Literal ID="litRentYieldPerSFTText" Text=" Rent yield per Sft for period&nbsp;<b>(K/C)</b> :"
                                                                                runat="server"></asp:Literal>
                                                                        </td>
                                                                        <td style="text-align: right; border-bottom: 1px solid #ccccce;">
                                                                            <asp:Literal ID="litRentYieldPerSFT" runat="server"></asp:Literal>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding-left: 10px; border-bottom: 1px solid #ccccce;">
                                                                            <b>M)</b>
                                                                            <asp:Literal ID="litRentYieldPerDayText" Text=" Rent yield per Sft / day :" runat="server"></asp:Literal>
                                                                            &nbsp;<asp:Literal ID="litPercRentYieldPerDay" Text="<b>(L / No. of days)</b>" runat="server"></asp:Literal>
                                                                        </td>
                                                                        <td style="text-align: right; border-bottom: 1px solid #ccccce;">
                                                                            <asp:Literal ID="litRentYieldPerDay" runat="server"></asp:Literal>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
