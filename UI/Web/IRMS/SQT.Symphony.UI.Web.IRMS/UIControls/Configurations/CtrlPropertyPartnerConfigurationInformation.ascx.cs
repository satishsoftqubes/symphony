            ...
            if (Page.IsValid)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        propertyPartnerCount = PropertyPartnerBLL.CheckPropertyPartnerDuplication(new Guid(ddlPropertyName.SelectedValue), new Guid(ddlPartnerName.SelectedValue));
                        if (propertyPartnerCount > 0)
                        {
