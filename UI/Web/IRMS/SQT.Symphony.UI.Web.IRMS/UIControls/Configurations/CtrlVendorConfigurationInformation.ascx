<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlVendorConfigurationInformation.ascx.cs"
    Inherits="SQT.Symphony.UI.Web.IRMS.UIControls.Configurations.CtrlVendorConfigurationInformation" %>
                ...
                <td class="content" style="padding-left: 0px; width: 66.66%">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="box">
                        <tr>
                            ...
                            <td class="boxtopcenter">VENDOR SETUP
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table width="100%" cellpadding="3" cellspacing="3">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="VendorName" runat="server" Text="Vendor Name" CssClass="RequireFile"></asp:Label>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtVendorName" runat="server" SkinID="CmpTextbox" MaxLength="137"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="ContactName" runat="server" Text="Contact Name" CssClass="RequireFile"></asp:Label>
                                            <span class="erroraleart">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtContactName" runat="server" SkinID="CmpTextbox" MaxLength="137"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="VendorDetail" runat="server" Text="Vendor Detail" CssClass="RequireFile"></asp:Label>
                                            <span class="erroraleart">
                                                <asp:RequiredFieldValidator ID="rfvVendorDetail" runat="server" ControlToValidate="txtVendorDetail"
                                                    SetFocusOnError="true" CssClass="rfv_ErrorStar" ErrorMessage="*" ValidationGroup="Configuration" Display="Dynamic">
                                                </asp:RequiredFieldValidator></span>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtVendorDetail" TextMode="multiline" SkinID="CmpTextbox" Columns="10" Rows="3" runat="server" />
                                        ...
                                        <td align="left" valign="top" colspan="2" style="text-align: right;">
                                            <div>
                                                <asp:Button ID="btnNew" runat="server" Style="display: inline-block; margin-left: 5px; display: inline;"
                                                    Text="New" OnClientClick="fnDisplayCatchErrorMessage()" OnClick="btnNew_Click" />
                                                <asp:Button ID="btnSave" Text="Save" Style="display: inline-block; margin-left: 5px;"
                                                    runat="server" OnClick="Save_Vendor" ImageUrl="~/images/save.png" CausesValidation="true"
                            ...
                            <td>
                                <div class="box_leftmargin_content">
                                    ...
                                    <div style="height: 775px; overflow: auto;">
                                        <asp:GridView ID="grdVendorList" runat="server" ShowHeader="false" ShowFooter="false"
                                            SkinID="gvNoPaging" AutoGenerateColumns="false" Width="92%" OnRowCommand="grdVendorList_RowCommand"
                                            OnRowDataBound="grdVendorList_RowDataBound">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <div class="rightmargin_grid">
                                                            ...
                                                            <div class="leftmargin_icons">
                                                                <asp:ImageButton ID="btnEdit" ToolTip="Edit" runat="server" ImageUrl="~/images/edit.png"
                                                                    ...
                                                                    CommandName="EditData" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "VendorID")%>' OnClientClick="fnDisplayCatchErrorMessage()" />
                                                                <asp:ImageButton ID="btnDelete" ToolTip="Delete" runat="server" ImageUrl="~/images/delete_icon.png"
                                                                    Style="border: 0px; vertical-align: middle; margin-top: 7px; margin-right: 7px;"
                                                                    CommandName="DeleteData" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "VendorID")%>' OnClientClick="fnDisplayCatchErrorMessage()" />
