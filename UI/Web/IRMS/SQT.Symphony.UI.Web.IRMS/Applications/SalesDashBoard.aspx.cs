...
namespace SQT.Symphony.UI.Web.IRMS.Applications
{
    public partial class SalesDashBoard : System.Web.UI.Page
    {
        ...
        {
            /*
            string Query = "Select Grd.DisplayName, Grd.SeqNo From Mst_Gadget Grd Inner Join Mst_GradgetUserJoin GrdJn On GrdJn.GadgetID = Grd.GadgetID Where Grd.IsSales = 1 AND GrdJn.UserID = '" + Convert.ToString(Session["UserID"]) + "' Order By Grd.SeqNo ASC";
            //string Query = "Select Grd.DisplayName, Grd.SeqNo From Mst_Gadget Grd Inner Join Mst_GradgetUserJoin GrdJn On GrdJn.GadgetID = Grd.GadgetID Where Grd.IsSales = 1 Order By Grd.SeqNo ASC";
