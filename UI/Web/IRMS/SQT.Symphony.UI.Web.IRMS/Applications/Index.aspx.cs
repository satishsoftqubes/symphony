...
{
    public partial class Index : SQT.Symphony.UI.Web.IRMS.CommonPages.MasterPage
    {
        #region Form Load
        /// <summary>
        /// Form Load Event
        ...
        {
            string Query = "Select Grd.DisplayName, Grd.SeqNo From Mst_Gadget Grd Inner Join Mst_GradgetUserJoin GrdJn On GrdJn.GadgetID = Grd.GadgetID Where Grd.IsAdmin = 1 AND GrdJn.UserID = '" + Convert.ToString(Session["UserID"]) + "' Order By Grd.SeqNo ASC";
            //string Query = "Select Grd.DisplayName, Grd.SeqNo From Mst_Gadget Grd Inner Join Mst_GradgetUserJoin GrdJn On GrdJn.GadgetID = Grd.GadgetID Where Grd.IsAdmin = 1 Order By Grd.SeqNo ASC";
