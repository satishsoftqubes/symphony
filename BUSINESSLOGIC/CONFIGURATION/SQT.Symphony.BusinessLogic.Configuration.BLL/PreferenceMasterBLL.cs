...
namespace SQT.Symphony.BusinessLogic.Configuration.BLL
{
    public static class PreferenceMasterBLL
    {
        ...
        public static List<PreferenceMaster> SelectAllByPreference(Guid companyID, Guid propertyID, string Preference)
        {
            PreferenceMasterDAL _dataObject = new PreferenceMasterDAL();
            return _dataObject.SelectAllByPreference(companyID, propertyID, Preference);
        }
