        ...
        public List<TaxSlabe> SelectAll(TaxSlabe dtoObject)
        {
            ...
            try
            {
                using (new Tracer((SQTLogType.DataAccessTraceLog)))
                {
                    ...
                    if(dtoObject != null)  
                    {
                        obj = StoredProcedure(MasterDALConstant.TaxSlabeSelectAll)
		...
		public bool Insert(TaxSlabe dtoObject)
        {
            try
            {
                using (new Tracer((SQTLogType.DataAccessTraceLog)))
                {
                    ...
                    StoredProcedure(MasterDALConstant.TaxSlabeInsert)
                        .AddParameter("@TaxSlabID", dtoObject.TaxSlabID)
.AddParameter("@TaxID", dtoObject.TaxID)
.AddParameter("@TaxRate", dtoObject.TaxRate)
.AddParameter("@IsTaxFlat", dtoObject.IsTaxFlat)
        ...
        public bool Update(TaxSlabe dtoObject)
        {
            try
            {
                using (new Tracer((SQTLogType.DataAccessTraceLog)))
                {
                    ...
                    StoredProcedure(MasterDALConstant.TaxSlabeUpdate)
                        .AddParameter("@TaxSlabID", dtoObject.TaxSlabID)
.AddParameter("@TaxID", dtoObject.TaxID)
.AddParameter("@TaxRate", dtoObject.TaxRate)
.AddParameter("@IsTaxFlat", dtoObject.IsTaxFlat)
...
.AddParameter("@CompanyID", dtoObject.CompanyID)
        ...
        public bool Delete(Guid Keys)
        {
            try
            {
                StoredProcedure(MasterDALConstant.TaxSlabeDeleteByPrimaryKey)
...
,Keys)
        ...
        public TaxSlabe SelectByPrimaryKey(Guid Keys)
        {
            ...
            try
            {
                obj = StoredProcedure(MasterDALConstant.TaxSlabeSelectByPrimaryKey)
                            .AddParameter("@TaxSlabID"
,Keys)
                            .Fetch<TaxSlabe>();
            }
        ...
        public List<TaxSlabe> SelectByField(string fieldName, object value)
        {
            ...
            try
            {
                obj = StoredProcedure(MasterDALConstant.TaxSlabeSelectByField) 
        ...
        public bool DeleteByField(string fieldName, object value)
        {
            try
            {
                StoredProcedure(MasterDALConstant.TaxSlabeDeleteByField) 
                                    .AddParameter("@FieldName", fieldName)
                                    .AddParameter("@Value", value)
                                    .WithTransaction(dbtr)
                                    .Execute();
