...
BEGIN  
 SELECT   
  mst_Property.PropertyID, mst_Property.CompanyID, mst_Property.SeqNo, [PropertyTypeID], [PropertyCode], [PropertyName], [PurchaseOptionID], mst_Property.AddressID, [PropManagerName], [PrimaryContactNo], [PrimaryEmail], [PrimaryFax], [PropertyDisplayName], [PropertyRegisteredOn], 
