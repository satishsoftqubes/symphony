DROP PROCEDURE dbo.mst_Property_SelectData
USE [symphony_sakariyagroup]
GO
/****** Object:  StoredProcedure [dbo].[mst_Property_SelectData]    Script Date: 9/9/2022 6:05:19 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[mst_Property_SelectData]
(  
...
BEGIN  
 SELECT   
  mst_Property.PropertyID, mst_Property.CompanyID, mst_Property.SeqNo, [PropertyTypeID], [PropertyStatusID], [PropertyCode], [PropertyName], [PurchaseOptionID], [SurveyNo], [PaymentTermID], [Jantri], Price, PurchaseArea, TotalCost, mst_Property.AddressID, [PropManagerName], [PrimaryContactNo], [PrimaryEmail], [PrimaryFax], [PropertyDisplayName], [PropertyRegisteredOn], 
  ...
  SBAreaCommercial,KhataNo,BuldingPlanApprovalNo,KPSBNoc,SEACNOC,LicenceNo,CertificationNo,mst_Address.Village,
